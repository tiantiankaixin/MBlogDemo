...
extension UIView {
    ...
    @objc func ai_addBorder(width: CGFloat, color: UIColor) {
        self.layer.borderWidth = width
        self.layer.borderColor = color.cgColor
        self.layer.masksToBounds = true
    }
    
    @objc func ai_addShadow(shadowOpacity: Float, shadowRadius: CGFloat, cornerRadius: CGFloat, shadowColor: UIColor = UIColor.black, shadowOffset: CGSize = CGSize(width: 0, height: 1)) {
    ...
    @objc func ai_addShadow1(shadowOpacity: Float, shadowRadius: CGFloat, cornerRadius: CGFloat, shadowColor: UIColor = UIColor.black, shadowOffset: CGSize = CGSize(width: 0, height: 1)) {
...
////MARK: safe area
//let AISafeAreaInsets = {() -> UIEdgeInsets in
...
//}
//
//let AISafe_Top = AISafeAreaInsets().top
//
///// 根据当前机型返回对应传入的参数(iPad/iPhone)
///// - Parameter iPhone: iPhone参数
///// - Parameter iPad: iPad参数
//func AIDeviceValue<T>(iPhone: T, iPad: T) -> T {
//    if AIIsiPad {
//        return iPad
//    } else if AIIsiPhone {
//        return iPhone
